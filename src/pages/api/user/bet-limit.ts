...
export default async function handler(
  ...
  if (req.method === 'GET') {
    try {
      ...
      // Usar o valor do dailyBetLimit se existir, caso contrário usar o valor padrão
      // Fazemos a verificação direta para contornar o problema do campo possivelmente não existir
      const userDailyLimit = (user as any).dailyBetLimit || 5000;
